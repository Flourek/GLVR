...
{
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal delegate IntPtr _GetSettingsErrorNameFromEnum(EVRSettingsError m_Error);
	[MarshalAs(UnmanagedType.FunctionPtr)]
...
public class CVRSettings
{
	...
	public string GetSettingsErrorNameFromEnum(EVRSettingsError m_Error)
	{
		IntPtr result = FnTable.GetSettingsErrorNameFromEnum(m_Error);
		return (string) Marshal.PtrToStructure(result, typeof(string));
	}
...
public class OpenVR
{
	...
	class COpenVRContext
	{
		...
		public CVRSystem VRSystem()
		{
			...
			if (m_pVRSystem == null)
			{
				var m_Error = EVRInitError.None;
				var pInterface = OpenVRInterop.GetGenericInterface(FnTable_Prefix+IVRSystem_Version, ref m_Error);
				if (pInterface != IntPtr.Zero && m_Error == EVRInitError.None)
		...
		public CVRChaperone VRChaperone()
		{
			...
			{
				var m_Error = EVRInitError.None;
				var pInterface = OpenVRInterop.GetGenericInterface(FnTable_Prefix+IVRChaperone_Version, ref m_Error);
				if (pInterface != IntPtr.Zero && m_Error == EVRInitError.None)
		...
		public CVRChaperoneSetup VRChaperoneSetup()
		{
			...
			{
				var m_Error = EVRInitError.None;
				var pInterface = OpenVRInterop.GetGenericInterface(FnTable_Prefix+IVRChaperoneSetup_Version, ref m_Error);
				if (pInterface != IntPtr.Zero && m_Error == EVRInitError.None)
		...
		public CVRCompositor VRCompositor()
		{
			...
			{
				var m_Error = EVRInitError.None;
				var pInterface = OpenVRInterop.GetGenericInterface(FnTable_Prefix+IVRCompositor_Version, ref m_Error);
				if (pInterface != IntPtr.Zero && m_Error == EVRInitError.None)
		...
		public CVROverlay VROverlay()
		{
			...
			{
				var m_Error = EVRInitError.None;
				var pInterface = OpenVRInterop.GetGenericInterface(FnTable_Prefix+IVROverlay_Version, ref m_Error);
				if (pInterface != IntPtr.Zero && m_Error == EVRInitError.None)
		...
		public CVRRenderModels VRRenderModels()
		{
			...
			{
				var m_Error = EVRInitError.None;
				var pInterface = OpenVRInterop.GetGenericInterface(FnTable_Prefix+IVRRenderModels_Version, ref m_Error);
				if (pInterface != IntPtr.Zero && m_Error == EVRInitError.None)
		...
		public CVRExtendedDisplay VRExtendedDisplay()
		{
			...
			{
				var m_Error = EVRInitError.None;
				var pInterface = OpenVRInterop.GetGenericInterface(FnTable_Prefix+IVRExtendedDisplay_Version, ref m_Error);
				if (pInterface != IntPtr.Zero && m_Error == EVRInitError.None)
		...
		public CVRSettings VRSettings()
		{
			...
			{
				var m_Error = EVRInitError.None;
				var pInterface = OpenVRInterop.GetGenericInterface(FnTable_Prefix+IVRSettings_Version, ref m_Error);
				if (pInterface != IntPtr.Zero && m_Error == EVRInitError.None)
		...
		public CVRApplications VRApplications()
		{
			...
			{
				var m_Error = EVRInitError.None;
				var pInterface = OpenVRInterop.GetGenericInterface(FnTable_Prefix+IVRApplications_Version, ref m_Error);
				if (pInterface != IntPtr.Zero && m_Error == EVRInitError.None)
